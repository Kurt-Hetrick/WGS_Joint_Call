...
START_EXTRACT_CODING_PASS_ALL_SNV=`date '+%s'`
...
-o $CORE_PATH/$OUT_PROJECT/SNV/MULTI/CODING/PASS_ALL/$SM_TAG".CODING.SNV.ALL.PASS.vcf.gz"

END_EXTRACT_CODING_PASS_ALL_SNV=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",J.01,EXTRACT_CODING_PASS_ALL_SNV,"$HOSTNAME","$START_EXTRACT_CODING_PASS_ALL_SNV","$END_EXTRACT_CODING_PASS_ALL_SNV \
