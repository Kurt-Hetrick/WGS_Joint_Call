...
-o $CORE_PATH/$OUT_PROJECT/SNV/MULTI/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.SNV.vcf.gz"

END_EXTRACT_WG_SNV=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",J.01,EXTRACT_WG_SNV,"$HOSTNAME","$START_EXTRACT_WG_SNV","$END_EXTRACT_WG_SNV \
