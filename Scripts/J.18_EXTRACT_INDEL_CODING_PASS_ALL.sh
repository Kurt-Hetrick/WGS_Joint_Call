...
START_EXTRACT_CODING_PASS_ALL_INDEL=`date '+%s'`
...
-o $CORE_PATH/$OUT_PROJECT/INDEL/MULTI/CODING/PASS_ALL/$SM_TAG".CODING.INDEL.ALL.PASS.vcf.gz"

END_EXTRACT_CODING_PASS_ALL_INDEL=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",J.01,EXTRACT_CODING_PASS_ALL_INDEL,"$HOSTNAME","$START_EXTRACT_CODING_PASS_ALL_INDEL","$END_EXTRACT_CODING_PASS_ALL_INDEL \
