...
-o $CORE_PATH/$OUT_PROJECT/VCF/MULTI/CODING/PASS_ALL/$SM_TAG".CODING.ALL.PASS.vcf.gz"

END_EXTRACT_CODING_PASS_VARIANT=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",J.01,EXTRACT_CODING_PASS_ALL,"$HOSTNAME","$START_EXTRACT_CODING_PASS_ALL","$END_EXTRACT_CODING_PASS_ALL \
