...
-o $CORE_PATH/$OUT_PROJECT/VCF/MULTI/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.vcf.gz"

END_EXTRACT_WG=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",J.01,EXTRACT_WG,"$HOSTNAME","$START_EXTRACT_WG","$END_EXTRACT \
