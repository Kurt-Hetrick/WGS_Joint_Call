...
-o $CORE_PATH/$OUT_PROJECT/MIXED/MULTI/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.MIXED.vcf.gz"

END_EXTRACT_MIXED_WG=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",J.01,EXTRACT_MIXED_WG,"$HOSTNAME","$START_EXTRACT_MIXED_WG","$END_EXTRACT_MIXED_WG \
