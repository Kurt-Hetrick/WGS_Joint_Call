...
-o $CORE_PATH/$OUT_PROJECT/VCF/MULTI/CODING/$SM_TAG".CODING.vcf.gz"

END_EXTRACT_CODING=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",J.01,EXTRACT_CODING,"$HOSTNAME","$START_EXTRACT_CODING","$END_EXTRACT_CODING \
