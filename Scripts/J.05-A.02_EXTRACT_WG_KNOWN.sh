...
-o $CORE_PATH/$OUT_PROJECT/TEMP/$SM_TAG".QC.WG.Known.TiTv.vcf.gz"

END_EXTRACT_WG_KNOWN=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",K.01,EXTRACT_WG_KNOWN,"$HOSTNAME","$START_EXTRACT_WG_KNOWN","$END_EXTRACT_WG_KNOWN \
