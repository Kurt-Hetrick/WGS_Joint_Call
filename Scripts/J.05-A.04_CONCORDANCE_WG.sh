...
>| $CORE_PATH/$OUT_PROJECT/TEMP/$SM_TAG/$SM_TAG".WHOLE.GENOME.SNV.VARIANT.PASS.vcf"
...
$CORE_PATH/$OUT_PROJECT/REPORTS/CONCORDANCE/MULTI/$SM_TAG"_concordance.csv"

mv $CORE_PATH/$OUT_PROJECT/TEMP/$SM_TAG/missing_data.csv \
$CORE_PATH/$OUT_PROJECT/REPORTS/CONCORDANCE/MULTI/$SM_TAG"_missing_data.csv"

mv $CORE_PATH/$OUT_PROJECT/TEMP/$SM_TAG/discordant_data.csv \
$CORE_PATH/$OUT_PROJECT/REPORTS/CONCORDANCE/MULTI/$SM_TAG"_discordant_calls.csv"
