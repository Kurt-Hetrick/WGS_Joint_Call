...
-o $CORE_PATH/$OUT_PROJECT/SNV/MULTI/CODING/$SM_TAG".CODING.SNV.vcf.gz"

END_EXTRACT_CODING_SNV=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",J.01,EXTRACT_EXTRACT_CODING_SNV,"$HOSTNAME","$START_EXTRACT_CODING_SNV","$END_EXTRACT_CODING_SNV \
