...
START_EXTRACT_CODING_PASS_ALL_MIXED=`date '+%s'`
...
-o $CORE_PATH/$OUT_PROJECT/MIXED/MULTI/CODING/PASS_ALL/$SM_TAG".CODING.MIXED.PASS.ALL.vcf.gz"

END_EXTRACT_CODING_PASS_ALL_MIXED=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$IN_PROJECT",J.01,EXTRACT_CODING_PASS_ALL_MIXED,"$HOSTNAME","$START_EXTRACT_CODING_PASS_ALL_MIXED","$END_EXTRACT_CODING_PASS_ALL_MIXED \
